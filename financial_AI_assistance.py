...
def remove_portfolio():
    ...
    if ticker in portfolio.keys():
        ...
        print(f"You don't own any of {ticker} shares!")
...
def portfolio_gains():
    ...
    try:
        ...
        print('There is no trading at this day!')
...
# Create an instance of the GenericAssistant with the legacy optimizer
assistant = GenericAssistant('intents.json', intent_metpihods=mappings, model_name='financial_assistant_model')
